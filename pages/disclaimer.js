    ...
    return (
      <div className="container">
        ...
        <div className="max-w-4xl mx-auto w-full p-4 my-16">
          ...
          <p className="text-sm italic font-semibold mt-2">
            Last updated: 11/01/2022
          </p>

          <p className="mt-4">
            The information provided by YutMp3 (“We,” “Us” or “Our”) on
            YutMp3.DOWNLOAD (the “Website”) is for general informational
            purposes only. All information on the Website is provided in good
          ...
          <p>
            YutMp3 is a Social Media Services website and is not associated by
            any means to Facebook or the Facebook brand and doesn't have
            anything to do with Facebook, Inc.
          </p>

          <h2 className="mt-4 text-2xl font-semibold">1 - Consent</h2>

          <p>
            By using the Website, You hereby consent to this Disclaimer and
            agree to its terms.
            <br />
            We will not be liable for any damages experienced in connection with
            the use of Our Website.
            <br />
            If You do not agree with this Disclaimer, STOP now and do not access
            or use this Website.
          </p>
          ...
          <p>
            The Website may contain (or You may be sent through the Website
            links to other sites or content belonging to or originating from
            third parties or links to sites and features in banners or other
            advertising. We do not investigate, monitor, or check such external
            links for accuracy, adequacy, validity, reliability, availability or
            completeness.
            <br />
            ...
            third-party websites linked through the Website or any site or
          ...
          <p>
            The Website contains copyrighted material the use of which has not
            ...
            You wish to use copyrighted material from the Website for purposes
          ...
          <p>
            You acknowledge You are using Our Website voluntarily and that any
            ...
            made or action taken in reliance on the information given in the
            Website.
          </p>
          ...
          <p>
            ...
            Website's disclaimer, please feel free to contact Us by our contact
            page or by email at contact@fbdown.net.
          </p>
          ...
          <p>COPYRIGHT 2022 YutMp3. ALL RIGHTS RESERVED.</p>
        </div>
