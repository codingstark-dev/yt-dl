...
export default function App({ Component, pageProps }) {
  ...
  useEffect(() => {
    const infoStyle = "color: red; font-family:sans-serif; background-color: white; border-radius: 5px; padding: 5px; font-weight: bold;";
  ...
  return (
      ...
      >
        <InstallPWA
          show={PWAInstallData.showPrompt}
          install={installPwa}
          close={cancelInstallPwa}
        />
        <Component {...pageProps} />
      </ThemeProvider>
