...
const Display = ({ Data, Url }): JSX.Element => {
  ...
  //     `http://137.184.232.87:4000/dl?url=${Url}&type=mp3&title=${encodeURIComponent(
  ...
  //     `http://137.184.232.87:4000/dl?url=${Url}&bit=${bit}&type=mp4&title=${encodeURIComponent(
  //       "sdasdsad"
  //     )}`,
  //     {
  //       responseType: "arraybuffer",
  ...
  //   );
  //   let responseMp3 = await axios.get(
  //     `http://137.184.232.87:4000/dl?url=${Url}&type=mp3&title=${encodeURIComponent("sdasdsad")}`,
  //     {
  //       responseType: "arraybuffer",
  //     }
  //   );

  //   // `http://137.184.232.87:4000/dl?url=${encodeURIComponent(
      ...
      <>
        ...
        >
          ...
          {/* <video
            ...
            src={`http://137.184.232.87:4000/dl?url=${encodeURIComponent()}&type=${"mp4"}&title=${Math.floor(
              Math.random() * 100000000000
            )}`}
            controls
          ></video> */}
                ...
                return (
                  <tr key={index}>
                    ...
                    <td className="border px-4 py-2">
                      <Link
                        href={`http://137.184.232.87:4000/dl?url=${encodeURIComponent(
                          Data.data.url
                        )}&type=mp3&dltype=${
                          Data.api
              ...
              {/* <tr>
                ...
                <td className="border px-4 py-2 text-sm">
                  <Link
                    href={`http://137.184.232.87:4000/dl?url=${encodeURIComponent(
                      SiteDetails.website +
                        "http://137.184.232.87:4000/mp3?url=" +
                        Url +
                        `&bit=${320}&type=mp3`
            ...
            <tbody>
              {Data?.data.formats.map((e, index) => {
                return e.asr != null && e.quality != 0 && e.height != null ? (
                  <tr key={index}>
                    ...
                    <td className="border px-4 py-2">
                      <Link
                        href={`http://137.184.232.87:4000/dl?url=${encodeURIComponent(e.url)}&type=${
                          e.format.includes("audio") ? "mp3" : "mp4"
              ...
              {/* <tr>
                ...
                <td className="border px-4 py-2 text-sm">
                  <Link
                    href={
                      `http://137.184.232.87:4000/dl?url=` +
                      SiteDetails.website +
                      `http://137.184.232.87:4000/download?url=` +
              ...
              {listOFbit.map((e, index) => {
                return (
                  <tr key={index}>
                    ...
                    <td className="border px-4 py-2">
                      <Link
                        href={`http://137.184.232.87:4000/dl?url=${Url}&type=mp3&dltype=${
                          Data.api
                        }&bit=${e}&title=${encodeURIComponent(
